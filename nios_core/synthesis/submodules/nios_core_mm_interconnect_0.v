...
`timescale 1 ps / 1 ps
module nios_core_mm_interconnect_0 (
		...
		input  wire [17:0] nios2_gen2_data_master_address,               //                 nios2_gen2_data_master.address
	...
	wire  [17:0] nios2_gen2_data_master_translator_avalon_universal_master_0_address;              // nios2_gen2_data_master_translator:uav_address -> nios2_gen2_data_master_agent:av_address
	...
	wire  [17:0] nios2_gen2_instruction_master_translator_avalon_universal_master_0_address;       // nios2_gen2_instruction_master_translator:uav_address -> nios2_gen2_instruction_master_agent:av_address
	...
	wire   [8:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [17:0] nios2_gen2_debug_mem_slave_agent_m0_address;                                      // nios2_gen2_debug_mem_slave_agent:m0_address -> nios2_gen2_debug_mem_slave_translator:uav_address
	...
	wire   [8:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> nios2_gen2_debug_mem_slave_agent:cp_channel
	...
	wire  [17:0] onchip_memory2_s1_agent_m0_address;                                               // onchip_memory2_s1_agent:m0_address -> onchip_memory2_s1_translator:uav_address
	...
	wire   [8:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire  [17:0] ledg_s1_agent_m0_address;                                                         // ledg_s1_agent:m0_address -> ledg_s1_translator:uav_address
	...
	wire   [8:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> ledg_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> ledr_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_007_src_data;                                                             // cmd_mux_007:src_data -> sw_s1_agent:cp_data
	...
	wire  [95:0] cmd_mux_008_src_data;                                                             // cmd_mux_008:src_data -> key_s1_agent:cp_data
	...
	wire  [95:0] ledg_s1_agent_rp_data;                                                            // ledg_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [95:0] ledr_s1_agent_rp_data;                                                            // ledr_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [95:0] sw_s1_agent_rp_data;                                                              // sw_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [95:0] key_s1_agent_rp_data;                                                             // key_s1_agent:rp_data -> router_010:sink_data
	...
	wire   [8:0] router_src_channel;                                                               // router:src_channel -> nios2_gen2_data_master_limiter:cmd_sink_channel
	...
	wire   [8:0] nios2_gen2_data_master_limiter_cmd_src_channel;                                   // nios2_gen2_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [8:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_gen2_data_master_limiter:rsp_sink_channel
	...
	wire   [8:0] router_001_src_channel;                                                           // router_001:src_channel -> nios2_gen2_instruction_master_limiter:cmd_sink_channel
	...
	wire   [8:0] nios2_gen2_instruction_master_limiter_cmd_src_channel;                            // nios2_gen2_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [8:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_gen2_instruction_master_limiter:rsp_sink_channel
	...
	wire   [8:0] nios2_gen2_data_master_limiter_cmd_valid_data;                                    // nios2_gen2_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [8:0] nios2_gen2_instruction_master_limiter_cmd_valid_data;                             // nios2_gen2_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	nios_core_mm_interconnect_0_router router (
	...
	nios_core_mm_interconnect_0_router_001 router_001 (
	...
	nios_core_mm_interconnect_0_router_002 router_002 (
	...
	nios_core_mm_interconnect_0_router_003 router_003 (
	...
	nios_core_mm_interconnect_0_router_002 router_004 (
	...
	nios_core_mm_interconnect_0_router_002 router_005 (
	...
	nios_core_mm_interconnect_0_router_003 router_006 (
	...
	nios_core_mm_interconnect_0_router_003 router_007 (
	...
	nios_core_mm_interconnect_0_router_003 router_008 (
	...
	nios_core_mm_interconnect_0_router_003 router_009 (
	...
	nios_core_mm_interconnect_0_router_003 router_010 (
	...
	nios_core_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                          //        clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                                 //        clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_001 cmd_mux_006 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_001 cmd_mux_007 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_001 cmd_mux_008 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux_001 rsp_demux_006 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux_001 rsp_demux_007 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux_001 rsp_demux_008 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
